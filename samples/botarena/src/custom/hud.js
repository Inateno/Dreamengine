...
function( DE )
{
  ...
  function HUD( data )
  {
    ...
    this.waveNumber = new DE.TextRenderer( "Wave number : ", {
          y         : 15
          ,textStyle: HUD.topLeftTextStyle 
        } );
    ...
    this.upgradePanel = new DE.GameObject( {
      ...
      ,renderers: [
        ...
        ,new DE.TextRenderer( "Choose an upgrade !", {
          y         : -75
          ,zindex   : 10
          ,textStyle: HUD.upgradePanelTextStyle
        })
  ...
  HUD.prototype.showDead = function( score )
  {
    ...
    this.addAutomatism( "openHome", "openHome", { interval: 3000, persistent: false } );
  }
