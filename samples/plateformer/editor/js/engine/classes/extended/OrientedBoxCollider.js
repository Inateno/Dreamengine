...
define( [ 'DE.Collider', 'DE.CONFIG', 'DE.CanvasBuffer' ],
function( Collider, CONFIG, CanvasBuffer )
{
  function OrientedBoxCollider(  param )
  {
    param = param || {};
    ...
    this.DEName = "OrientedBoxCollider";
    ...
    // {
      ...
      this.debugBuffer.ctx.strokeRect( _left, _top, this.width, this.height);
  ...
  {
    console.log( "OrientedBoxCollider loaded" );
  }
