 ...
 * } );
 */
define( [ 'DE.Renderer', 'DE.CircleRenderer.render', 'DE.CONFIG' ],
function( Renderer, CircleRender, CONFIG )
{
  function CircleRenderer( params, radius, angleStart, angleEnd, clockRotation )
  {
    ...
    {
      this.buffer = null; //new CanvasBuffer( this.radius * 2 + this.lineWidth, this.radius * 2 + this.lineWidth );
      // this.redraw();
    }
